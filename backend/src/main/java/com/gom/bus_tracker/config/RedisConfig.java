...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, BusPositionDTO> redisBusTemplate(RedisConnectionFactory connectionFactory) {
        RedisTemplate<String, BusPositionDTO> template = new RedisTemplate<>();
